...
> does — SigV4-authenticated, **eighteen services and counting, each backed by a real datastore and
...
answers as AWS for **eighteen probe-proven services** — see
...
**Eighteen services are fronted, and every one is proven by a real-AWS-SDK compatibility probe** (`probe/aws-shim-*.sh`,
...
hand-wavy**. "Eighteen probe-proven services" is not "all of AWS"; it is a specific, verified surface.
