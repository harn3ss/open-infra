...
> does — SigV4-authenticated, **fifteen services and counting, each backed by a real datastore and
...
answers as AWS for **fifteen probe-proven services** — see
...
**Fifteen services are fronted, and every one is proven by a real-AWS-SDK compatibility probe** (`probe/aws-shim-*.sh`,
...
hand-wavy**. "Fifteen probe-proven services" is not "all of AWS"; it is a specific, verified surface.
