...
| **Database** (RDS) | Overview (phase/instances/storage + **Start/Stop**), **Peek** (live connections / CDC lag / top queries), Connectivity (host/port/db/user + connection URI), Monitoring, YAML. See [databases.md](databases.md) |
