...
func render(d Doc, nl Nightly) string {
	...
	h.WriteString("> **These four chaos docs:** [primitive](chaos.md) (`kind: FaultInjection`) → ")
	h.WriteString("[judging](chaos-oracle.md) (the oracle: modes + pillars) → [nightly program](chaos-suite.md) ")
	h.WriteString("(safety, graduation) → **catalog + live status** (this page, generated).\n\n")
