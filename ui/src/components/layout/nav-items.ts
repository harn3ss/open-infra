...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "HTTP APIs", to: "/http-apis", icon: Webhook, matchPrefix: true, section: "Compute" },
  ...
  { label: "Static Sites", to: "/staticsites", icon: AppWindow, matchPrefix: true, section: "Compute" },

  { label: "Databases", to: "/databases", icon: Database, matchPrefix: true, section: "Data" },
  { label: "Tables", to: "/tables", icon: Table2, matchPrefix: true, section: "Data" },
  { label: "Database Proxies", to: "/database-proxies", icon: DatabaseZap, matchPrefix: true, section: "Data" },
  ...
  { label: "Email Senders", to: "/emailsenders", icon: Mail, matchPrefix: true, section: "Data" },
  ...
  { label: "VPC Dashboard", to: "/networking", icon: Network, matchPrefix: true, section: "Networking" },
  { label: "VPCs", to: "/vpcs", icon: Network, matchPrefix: true, section: "Networking" },
  { label: "Subnets", to: "/subnets", icon: LayoutGrid, matchPrefix: true, section: "Networking" },
  { label: "NAT Gateways", to: "/nat-gateways", icon: Waypoints, matchPrefix: true, section: "Networking" },
  { label: "Elastic IPs", to: "/elastic-ips", icon: Globe, matchPrefix: true, section: "Networking" },
  { label: "Transit Gateways", to: "/transit-gateways", icon: Share2, matchPrefix: true, section: "Networking" },
  { label: "Flow Logs", to: "/flow-logs", icon: ScrollText, matchPrefix: true, section: "Networking" },
  { label: "Security Groups", to: "/security-groups", icon: Shield, matchPrefix: true, section: "Networking" },

  { label: "IAM Dashboard", to: "/iam", icon: Fingerprint, matchPrefix: true, section: "Security & Identity" },
  ...
  { label: "Policy Simulator", to: "/policy-simulator", icon: FlaskConical, matchPrefix: true, section: "Security & Identity" },
  ...
  { label: "User Pools", to: "/user-pools", icon: IdCard, matchPrefix: true, section: "Security & Identity" },
  ...
  { label: "Parameters", to: "/parameters", icon: SlidersHorizontal, matchPrefix: true, section: "Security & Identity" },
